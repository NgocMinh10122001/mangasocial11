          ...
          <div className="flex flex-col gap-[8px] md:gap-[40px]">
            ...
            <div className="flex flex-col gap-[40px]">
              ...
              <div className="flex  gap-5">
                <Link to={`/${sv}/${sv === 4  || sv === 11 || sv === 12 ? "novel" : "chapter"}/${slug}/${readmode ? getChapterFromUrl2(linkList[0]?? "") : getChapterFromUrl(linkList[0]?? "")}`} className=" hover:text-white p-[8px]  rounded-[12px] md:px-[52px] md:py-[26px]  bg-[#FF2020]  text-white md:rounded-[67px] ">
